      ...
      >
        <div className="title-bar select-none" ref={titleBarRef}>
          ...
          <div className="title-bar-controls">
            <button aria-label="Minimize" onClick={closeDialog}></button>
            {!maximized && (
              <button
                aria-label="Maximize"
                onClick={() => {
                  setMaximized(true);
                  if (windowRef.current && win7DialogRef.current) {
                    win7DialogRef.current.style.width = "100vw";
                    win7DialogRef.current.style.height = "100vh";
                    ...
                    win7DialogRef.current.style.left = "0px";
                    windowRef.current.style.borderRadius = "0px";
                  }
                }}
              ></button>
            )}
            {maximized && (
              <button
                ...
                onClick={() => {
                  setMaximized(false);
                  if (windowRef.current && win7DialogRef.current) {
                    win7DialogRef.current.style.width = "auto";
                    win7DialogRef.current.style.height = "auto";
                    ...
                    win7DialogRef.current.style.left = loc.x;
