...
export default function PokemonSearchSuggestions({
  ...
  return createPortal(
    <>
    <style jsx>{`.ws {width: ${width}px;} .ls {left: ${left}px} .ts {top: ${top + 4}px;}`}</style>
    <div 
      className={`ws ls ts fixed rounded-lg border border-gray-300 bg-white/80 shadow-lg backdrop-blur-sm z-[9999] dark:border-gray-600 dark:bg-gray-800/80`}
    >
