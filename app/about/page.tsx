        ...
        <main className="flex flex-col items-center justify-center">
            ...
            <div className="float-left w-1/2 text-left sm:w-1/3 sm:text-xs md:w-2/3 md:text-sm">
                <h2 title="I Like This" className="text-lg">
                    What to do when you like this site, and wish yours was like
                    this.
                </h2>
                <br />
                <p>
                    If you wish your site were something like this, then you can
                    use this site as a base!
                    <br />
                ...
                <br />
                <p>
                    I am a <Age /> year old developer. I program in a lot of
                    languages, but I am best at TypeScript and Html. I also
                    program in C# and some java and batch. I mainly use windows,
                    but I have a raspberry pi 4b with retropie. I listen to
                    music on spotify and I play a lot of{" "}
                    ...
                    I am a big fan of{" "}
                    <Link href="https://itsfoss.com/">F.O.S.S.</Link> and{" "}
                    <Link href="https://www.github.com/">GitHub</Link>! I use
                    VSCode and Visual Studio for programming.
                </p>
            </div>
            <br />
        </main>
