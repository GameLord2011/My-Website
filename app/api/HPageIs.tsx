    ...
    <>
      {isBrowser && (
        <div>
          ...
          {process.env.NODE_ENV === "production" && bot === false && (
            <Link
              href="http://s01.flagcounter.com/more/ugnH"
          ...
          {process.env.NODE_ENV === "development" && bot === false && (
            <Link
              href="http://s05.flagcounter.com/more/xU6"
              className="hidden bottom-0 p-0 m-0 left-0 fixed dark:block w-auto h-auto"
            >
              <Image
                className="Flag_cntr"
