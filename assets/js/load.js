/* await */ tsParticles.load({
    ...
    // options: /* the options of the instance, can be an array of options object, optional if url is passed, if none is passed it's meaningless to load anything */
     url: "assets/json/particles.json" /* the url used to load the options, uses AJAX to get the options object, the result is then used like the options object above. */
  });
